...
export default class O2MRelation extends Relation {
   ...
   */
  @Memoize()
  public getName(relationNameFunction: RelationNameFunctions | BuiltinRelationNameFunctions): string {
    return getRelationNameFunctions(relationNameFunction).o2m(this);
  }
